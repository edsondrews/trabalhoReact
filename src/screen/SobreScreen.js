        ...
        return (
            <View style={styles.container}>
                <View style={styles.allViews}>
                    ...
                    <ImageBackground resizeMode="cover" source={{ uri: 'https://www.hypeness.com.br/wp-content/uploads/2016/07/Breaking-Bad-c0e20f30.jpg' }}
                        style={styles.imagem}>
                        <View style={styles.textoView}>
                            <Text style={styles.texto}>Aluno: Edson Drews</Text>
                        </View>
                    </ImageBackground>
                </View>
            </View>
